"use strict";
(self["webpackChunkchat"] = self["webpackChunkchat"] || []).push([[654],{
...
/* harmony default export */ const SceneComponent = (function (_ref) {
  ...
  var _ref3 = (0,react_redux/* useSelector */.d4)(function (state) {
  ...
  (0,index_js_.useEffect)(function () {
    ...
    var initCanvas = function initCanvas() {
      ...
      if (!canvas) return;
      var engine = new core/* Engine */.N$8(canvas, antialias, engineOptions, adaptToDeviceRatio);
      setEngine(engine);
      var scene = new core/* Scene */.Z58(engine, sceneOptions);
      setScene(scene);
...
;// CONCATENATED MODULE: ./src/components/pages/verse/Verse.jsx
    ...
    return Verse_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          camera = new core/* FreeCamera */.SCQ("camera1", new core/* Vector3 */.Pq0(0, 2, -6), scene); // This targets the camera to scene origin
          ...
          target = new core/* TransformNode */.VR0();
          currentState = "idle";
          speed = 0;
          rotation = 0;
          mouseSpeed = 1.0;
          ...
          scene.onPointerMove = function (evt) {
            ...
            lmx = mx;
            lmy = my;
            target.rotation = new core/* Vector3 */.Pq0(core/* Tools */.S0q.ToRadians(mouseY) % 360, core/* Tools */.S0q.ToRadians(mouseX) % 360, 0);
          };
          //mouse lock
          ...
          light = new core/* HemisphericLight */.g4z("light", new core/* Vector3 */.Pq0(0, 1, 0), scene); // Default intensity is 1. Let's dim the light a small amount
          light.intensity = 0.7;

          // Our built-in 'box' shape. make it light blue #1565c0
          box = core/* MeshBuilder */.PeD.CreateBox("box", {
            size: 0.5
          }, scene);
          material = new core/* StandardMaterial */.FUi("material", scene);
          material.diffuseTexture = new core/* Texture */.gPd("/avatars/1.jpg", scene);
          ...
          box2 = core/* MeshBuilder */.PeD.CreateBox("box2", {
            size: 0.5
          }, scene);
          box2.position.y = 1.7;
          box2.position.z = -3;
          material2 = new core/* StandardMaterial */.FUi("material2", scene);
          material2.diffuseTexture = new core/* Texture */.gPd("/avatars/2.jpg", scene);
          material2.diffuseColor = new core/* Color3 */.v9j(0.212, 0.596, 0.941);
          box2.material = material2;

          // create another box above with different colored sides
          box3 = core/* MeshBuilder */.PeD.CreateBox("box3", {
            size: 0.5
          }, scene);
          box3.position.y = 2.4;
          box3.position.z = -3;
          material3 = new core/* StandardMaterial */.FUi("material3", scene);
          material3.diffuseTexture = new core/* Texture */.gPd("/avatars/3.jpg", scene);
          box3.material = material3;

          // create another box above with different colored sides
          box4 = core/* MeshBuilder */.PeD.CreateBox("box4", {
            size: 0.5
          }, scene);
          box4.position.y = 1;
          box4.position.x = 0.9;
          box4.position.z = -3;
          material4 = new core/* StandardMaterial */.FUi("material4", scene);
          material4.diffuseTexture = new core/* Texture */.gPd("/avatars/4.jpg", scene);
          material4.diffuseColor = new core/* Color3 */.v9j(0.212, 0.596, 0.941);
          box4.material = material4;

          // create another box above with different colored sides
          box5 = core/* MeshBuilder */.PeD.CreateBox("box5", {
            size: 0.5
          }, scene);
          box5.position.y = 1.7;
          box5.position.x = 0.9;
          box5.position.z = -3;
          material5 = new core/* StandardMaterial */.FUi("material5", scene);
          material5.diffuseTexture = new core/* Texture */.gPd("/avatars/5.jpg", scene);
          box5.material = material5;

          // create another box above with different colored sides
          box6 = core/* MeshBuilder */.PeD.CreateBox("box6", {
            size: 0.5
          }, scene);
          box6.position.y = 2.4;
          box6.position.x = 0.9;
          box6.position.z = -3;
          material6 = new core/* StandardMaterial */.FUi("material6", scene);
          material6.diffuseTexture = new core/* Texture */.gPd("/avatars/6.jpg", scene);
          material6.diffuseColor = new core/* Color3 */.v9j(0.212, 0.596, 0.941);
          box6.material = material6;

          // create another box above with different colored sides
          box7 = core/* MeshBuilder */.PeD.CreateBox("box7", {
            size: 0.5
          }, scene);
          box7.position.y = 1;
          box7.position.x = -0.9;
          box7.position.z = -3;
          material7 = new core/* StandardMaterial */.FUi("material7", scene);
          material7.diffuseTexture = new core/* Texture */.gPd("/avatars/7.jpg", scene);
          material7.diffuseColor = new core/* Color3 */.v9j(0.212, 0.596, 0.941);
          box7.material = material7;

          // create another box above with different colored sides
          box8 = core/* MeshBuilder */.PeD.CreateBox("box8", {
            size: 0.5
          }, scene);
          box8.position.y = 1.7;
          box8.position.x = -0.9;
          box8.position.z = -3;
          material8 = new core/* StandardMaterial */.FUi("material8", scene);
          material8.diffuseTexture = new core/* Texture */.gPd("/avatars/8.jpg", scene);
          box8.material = material8;

          // create another box above with different colored sides
          box9 = core/* MeshBuilder */.PeD.CreateBox("box9", {
            size: 0.5
          }, scene);
          box9.position.y = 2.4;
          box9.position.x = -0.9;
          box9.position.z = -3;
          material9 = new core/* StandardMaterial */.FUi("material9", scene);
          material9.diffuseTexture = new core/* Texture */.gPd("/avatars/9.jpg", scene);
          material9.diffuseColor = new core/* Color3 */.v9j(0.212, 0.596, 0.941);
          box9.material = material9;

          // // the cat model
          _context.next = 92;
          return core/* SceneLoader */.cng.ImportMeshAsync(null, catModelPath, "", scene);
        case 92:
          ...
          catModel.rotate(new core/* Vector3 */.Pq0(1, 0, 0), Math.PI / 2);
          catModel.rotate(new core/* Vector3 */.Pq0(0, 0, 1), Math.PI);
          catModel.rotate(new core/* Vector3 */.Pq0(0, 1, 0), Math.PI);

          // add video texture to plane
          // const videoStream = await navigator.mediaDevices.getUserMedia({ video: true });

          core/* VideoTexture */.Nv2.CreateFromWebCam(scene, function (videoTexture) {
            // const videoTexture = new VideoTexture("video", videoStream, scene, true);
            mirror = core/* MeshBuilder */.PeD.CreateBox("mirror", {
              width: 1,
              height: 1
            }, scene);
            mirror.position.y = 1;
            ...
            var materialPlane = new core/* StandardMaterial */.FUi("materialPlane", scene);
          ...
          peerAvatar = core/* MeshBuilder */.PeD.CreateBox("peerAvatar", {
            size: 0.3
          }, scene);
          peerAvatar.position.y = 1;
          peerAvatar.position.z = 3;
          peerAvatar.position.x = 0;
          materialPeerAvatar = new core/* StandardMaterial */.FUi("materialPeerAvatar", scene);
          peerAvatarBase64String = peerAvatarBase64 || "/avatars/1.jpg";
          materialPeerAvatar.diffuseTexture = new core/* Texture */.gPd(peerAvatarBase64String, scene);
          peerAvatar.material = materialPeerAvatar;
          // green
          peerAvatar.material.diffuseColor = new core/* Color3 */.v9j(0.212, 0.941, 0.596);
          peerAvatar.rotation = camera.rotation;
          if (calls.length > 0) {
            core/* VideoTexture */.Nv2.CreateFromStreamAsync(scene, calls[0]._remoteStream, true).then(function (videoTexture) {
              peerPlane = core/* MeshBuilder */.PeD.CreatePlane("plane", {
                width: 1,
                height: 1
              }, scene);
              ...
              materialPlane.diffuseTexture = videoTexture;
              // white
              peerAvatar.material.diffuseColor = new core/* Color3 */.v9j(0.941, 0.941, 0.941);
          ...
          ground = core/* MeshBuilder */.PeD.CreateGround("ground", {
            width: 6,
            height: 6
          }, scene);
          groundMaterial = new core/* StandardMaterial */.FUi("groundMaterial", scene);
          groundMaterial.diffuseTexture = new core/* Texture */.gPd(!isDarkTheme ? darkBackground : lightBackground, scene);
          ground.material = groundMaterial;
          ground.position.y = 0.01;

          //hand
          handModelUrl = handModelPath; // Load the hand model
          core/* SceneLoader */.cng.ImportMeshAsync("", handModelUrl, "", scene).then(function (result) {
            var handMesh = result.meshes[0];
            handMesh.position = new core/* Vector3 */.Pq0(0, 2, 0); // Adjust position as needed
            ...
            handMesh.rotation = new core/* Vector3 */.Pq0(0, core/* Tools */.S0q.ToRadians(180), 0);
            handModel = handMesh;
          });
          _context.next = 121;
        ...
        case 121:
          ...
          if (!isInXr) {
            skydome = core/* MeshBuilder */.PeD.CreateBox("sky", {
              size: 1000,
              sideOrientation: core/* Mesh */.eaF.BACKSIDE
            }, scene);
          ...
          if (isDarkTheme) {
            scene.clearColor = new core/* Color3 */.v9j(0, 0, 0);
          } else {
            scene.clearColor = new core/* Color3 */.v9j(1, 1, 1);
          }
          if (!isInPod) {
            ...
            VJC = new core/* VirtualJoysticksCamera */._0R("VJC", scene.activeCamera.position, scene);
...
function Verse() {
  ...
  return /*#__PURE__*/index_js_default().createElement(PageContainer/* default */.A, {
    backgroundImage: "",
    headerProps: {
      // title: pageTitle,
      title: /*#__PURE__*/index_js_default().createElement("div", null, /*#__PURE__*/index_js_default().createElement(Typography/* default */.A, {
        variant: "h6",
        component: "div",
        sx: {
          flexGrow: 1
        }
      }, pageTitle), /*#__PURE__*/index_js_default().createElement(Typography/* default */.A, {
        variant: "subtitle2",
        component: "div",
        sx: {
          flexGrow: 1
...
//# sourceMappingURL=654.main.js.map